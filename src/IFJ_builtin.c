...
void generate_builtin()
{
    ...
    print_instruction("JUMPIFEQ $operation_error_divzero LF@tmp2 float@0x0p+0\n");
    ...
    print_instruction("INT2FLOAT LF@param3 LF@tmp\n");
    ...
    print_instruction("INT2FLOAT LF@tmp LF@param2\n");
    print_instruction("JUMPIFEQ $operation_error_divzero LF@param3 float@0x0p+0\n");
